...
class App extends React.Component{
    ...
    render(){
            ...
            if(this.state.searchuser == "@"){
              return<View><View  style={{height:height1/12,borderColor:"#7fc3e0",borderBottomWidth:2,padding:5,marginTop:5,backgroundColor:"white",flexDirection:"row"}}><Ionn name="close" onPress={()=>{this.props.navigation.navigate('Categori')}} size={30} style={{flex:1,marginTop:5}}/><TextInput editable={true}
