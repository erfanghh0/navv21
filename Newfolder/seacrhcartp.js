...
import { connect } from 'react-redux';
 ...
 constructor(){
   ...
   this.state={
     tt:0,
    // images :[{uri:Data[this.props.route.params.id].prev1,id:this.props.route.params.id},{uri:Data[this.props.route.params.id].prev2,id:this.props.route.params.id,},{uri:Data[this.props.route.params.id].prev1,id:this.props.route.params.id,}],id:this.props.route.params.id,
     selectedindex:0,
   ...
   //const productprops = this.props.route.params;
    ...
    const images = [{prev1:Data[this.props.route.params.id].prev1,id:1},{prev1:Data[this.props.route.params.id].prev2,id:2},{prev1:Data[this.props.route.params.id].prev3,id:3}]
    return<ScrollView>
         <TouchableOpacity onPress={()=>{if(Data[this.props.route.params.id].added == 0){this.check1(this.props.route.params.id);Data[this.props.route.params.id].added = 1;}else{Alert.alert("این آیتم در سبد حرید شما موجود است")};console.log(Data[this.props.route.params.id].added) ; }} style={{backgroundColor:"#85d9de",height:height1/15,width:height1/15,borderRadius:50,alignContent:"center",alignItems:"center",position:"absolute",elevation:3,zIndex:3,top:height1-height1/4.6,right:width1/10,justifyContent:"center",borderWidth:1,borderColor:"gray"}} ><Text style={{justifyContent:"center",fontSize:20,alignContent:"center",textAlign:"center",alignItems:"center",textAlignVertical:"center"}}>+سبد </Text></TouchableOpacity>
        <View>
     ...
     <Text style={{paddingHorizontal:width1/20,fontSize:20,paddingVertical:5}} onPress={()=>{console.warn(Data[this.props.route.params.id].colors.length)}}>محصول : {Data[this.props.route.params.id].name}</Text>
