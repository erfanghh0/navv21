  ...
  render(){
    ...
    return (
      ...
      :"white",height:height/16}}} >
        ...
        <Tab.Screen  name="پروفایل" component={Profile}  options={{header:()=><Text onPress={()=>{this.props.navigate()}}>sssss</Text>,tabBarIcon:({color,size})=>{return<Ionn name="person" color={color} size={30}></Ionn>},tabBarLabel:"پروفایل",tabBarActiveTintColor:"#7fc3e0"}} />
      </Tab.Navigator>
     <Texx/>
