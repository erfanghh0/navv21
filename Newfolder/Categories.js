 ...
 */
 ...
 import Categorishow from './categorishow'
 ...
 import searchcategori from './searchcategori'
 import {
   Colors,
   DebugInstructions,
   Header,
 ...
 import searchcategoriP from './searchCategoriP';
   ...
   render(){
     ...
     <View style={{padding:5,flexDirection:
       ...
       <View style={{flex:1}}><Text onPress={()=>{this.props.navigation.navigate('Categorishow',{catename : items.catename})}} style={{color:"#62b9e3",alignSelf:"flex-start",fontSize:20,padding:2}}>{this.state.text}</Text></View>
        <View style={{flex:1}}><Text onPress={()=>{Alert.alert("asdd")}} style={{alignSelf:"flex-end",fontSize:20,textAlign:"center",fontStyle:"normal",fontFamily:"Arial"}}>{items.catename}</Text></View>
        </View>
        <ScrollView style={{width:"100%",height:height1/4,backgroundColor:"white",padding:5}} horizontal={true}>
         
         <TouchableOpacity style={{borderRadius:5,paddingVertical:5,backgroundColor:"#e3edef",marginHorizontal:2,width: width1/3}} onPress={()=>{Alert.alert("sdsaaaaaad")}} onPress={()=>{this.props.navigation.navigate('Categorishow',{catename : items.catenamerefer1});console.warn(items.catenamerefer1)}} ><View><Image style={{width:80,height:80,marginHorizontal:20}} source={{uri:items.uri1}}/><Text style={{textAlign:"center",}}>{items.catenamerefer1}</Text></View></TouchableOpacity>
