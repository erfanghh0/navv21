...
import { connect } from 'react-redux';
 ...
 constructor(){
   ...
   //const productprops = this.props.route.params;
    ...
    return<ScrollView>
        <TouchableOpacity onPress={()=>{if(Data[this.props.route.params.id].added == 0){this.check1(this.props.route.params.id)}else{Alert.alert("این آیتم در سبد حرید شما موجود است")};console.log(Data[this.props.route.params.id].added) ;Data[this.props.route.params.id].added = 1; }} style={{backgroundColor:"#85d9de",height:height1/15,width:height1/15,borderRadius:50,alignContent:"center",alignItems:"center",position:"absolute",elevation:3,zIndex:3,top:height1-height1/4.6,right:width1/10,justifyContent:"center",borderWidth:1,borderColor:"gray"}} ><Text style={{justifyContent:"center",fontSize:20,alignContent:"center",textAlign:"center",alignItems:"center",textAlignVertical:"center"}}>+سبد </Text></TouchableOpacity>
        <View>
