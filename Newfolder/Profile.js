 ...
 class Profile extends React.Component{
   ...
   // this.props.navigation.setOptions({tabBarVisible:false})
     return(<ScrollView  keyboardShouldPersistTaps='handled' style={{alignSelf:"flex-end",height:height1,width:"100%",alignContent:"flex-start",flexDirection:"column-reverse",backgroundColor:"white"}}>
       ...
       <View style={{margin:5}}><Text style={{fontSize:height1/35}}>برای ورود به دیجیکالا شماره تلفن همراه خود را وارد کنید</Text></View>
       <StatusBar backgroundColor="white"      barStyle="dark-content"/>
        <View style={{marginHorizontal:5,backgroundColor:"white",padding:5}}><TouchableOpacity><TextInput  value={this.state.value}  onChangeText={(userName) => this.setState({value:userName})} keyboardShouldPersistTaps='handled' placeholder={"شماره تلفن خود را وارد کنید"} keyboardType="number-pad" underlineColorAndroid="dodgerblue" style={{width:"100%",height:height1/15+10,borderRadius:10,backgroundColor:"#d7ecec"}}/></TouchableOpacity></View>
        <View style={{marginHorizontal:5,backgroundColor:"white",padding:5}}>
          <TouchableOpacity style={{backgroundColor:"#85d9de",height:height1/15,borderRadius:10}} onPress={()=>{
            ...
            <Text style={{width:"100%",height:height1/15,borderRadius:10,textAlign:"center",textAlignVertical:"center",fontSize:height1/35}}>ورود به دیجیکالا{"   >"}</Text>
            </TouchableOpacity>
          </View>
      </ScrollView>
     )
